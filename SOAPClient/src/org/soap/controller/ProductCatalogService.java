 ...
 * 
 */
@WebServiceClient(name = "ProductCatalogService", targetNamespace = "http://controller.soap.org/", wsdlLocation = "http://aakash-pc:8080/SoapWebService/ProductCatalogService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PRODUCTCATALOGSERVICE_QNAME = new QName("http://controller.soap.org/", "ProductCatalogService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://aakash-pc:8080/SoapWebService/ProductCatalogService?wsdl");
    ...
    public ProductCatalogInterface getProductCatalogPort() {
        return super.getPort(new QName("http://controller.soap.org/", "ProductCatalogPort"), ProductCatalogInterface.class);
    }
     ...
     */
    @WebEndpoint(name = "ProductCatalogPort")
    public ProductCatalogInterface getProductCatalogPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://controller.soap.org/", "ProductCatalogPort"), ProductCatalogInterface.class, features);
    }
